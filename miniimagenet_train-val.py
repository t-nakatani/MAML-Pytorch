...
def main():
    ...
    mini_test = MiniImagenet('./flower/', mode='val', n_way=args.n_way, k_shot=args.k_spt,
                             k_query=args.k_qry,
        ...
        for step, (x_spt, y_spt, x_qry, y_qry) in enumerate(db):
            ...
            if step % 500 == 0 or (step == 10000//args.task_num - 1) & (epoch == range(args.epoch//10000)[-1]):  # evaluation
                ...
                if (step == 10000//args.task_num - 1) & (epoch == range(args.epoch//10000)[-1]):
                    with open('data/acc/natural2_val(task_num_' + str(args.task_num) +'epoch_num_'+ str(args.epoch) +  ').txt', mode='a') as f:
